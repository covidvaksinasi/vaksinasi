...
<body>
  ...
  <article class="tc w-75 center pt5 pb2 ph3 mw6-ns ba bw1 b--light-gray" style="background: #fff;">
    ...
    <p class="f6 tl lh-copy" style="margin: 20px;">Sistem pakar yang mampu mendiagnosa tindakan pada ayam berdasarkan pengetahuan yang diberikan langsung dari pakar/ahlinya dan melalui studi  literatur. Penelitian ini menggunakan metode perhitungan Certainty Factor (CF) dalam menghitung tingkat kepakaran. Data penelitian ini terdiri dari data gejala dan data tindakan ayam, serta data aturan. Sistem pakar pada organisasi ditujukan  untuk penambahan  value, peningkatan produktivitas serta area manajerial yang dapat mengambil kesimpulan dengan cepat.</p>
    <p/>
    ...
    3. Gabungkan (a) dan (b) :: CFc (CF1,CF2) = {CF1 + CF2} / (1-min{| CF1|,| CF2|})<br/>
        ...
        = 0,67<br/><br/></p>
    <p class="f6 tl lh-copy" style="margin: 20px;">
    Kesimpulannya: Suatu tindakan thypus disebabkan oleh gejala-gejala tersebut di atas memiliki nilai Certainty Factor ( CF) sebesar 0,67</p>
    <p/>        
    <p/>
  </article>
</div>
